...
classes = ('soil', 'sidewalk', 'vegetation', 'sky',
           'human', 'vehicle', 'building', 'wall', 'others')
palette = [[128, 64, 128], [244, 35, 232], [107, 142, 35], [70, 130, 180], [
    220, 20, 60], [0, 0, 142], [70, 70, 70], [102, 102, 156], [0, 0, 0]]
...
cfg_path = osp.abspath(osp.join(osp.dirname(
    __file__), 'configs/mobilenet_v3/lraspp_m-v3-d8_512x1024_320k_cityscapes.py'))
...
cfg.load_from = osp.abspath(
    osp.join(osp.dirname(__file__), 'checkpoint/MobileNetV3.pth'))
